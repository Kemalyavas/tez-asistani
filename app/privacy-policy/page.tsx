            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Hiçbir veri üçüncü taraflarla paylaşılmaz</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Türk veri koruma kanununa uyumludur</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <section>
              ...
              <div className="prose max-w-none text-gray-700">
                <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-4">
                  ...
                  <p className="text-blue-700 text-sm mt-1">Tez dosyalarınız yalnızca analiz hizmetini sunmak için kullanılır.</p>
                </div>
                
                <h3 className="text-lg font-semibold mb-2">Tez Dosyaları:</h3>
                <ul className="list-disc pl-6 mb-4 space-y-1">
                  <li>✅ Gerekli format standartlarına uygunluk kontrolü</li>
                  <li>✅ Atıf ve kaynak formatlama</li>
                  <li>✅ Yapay zeka destekli analiz ve öneriler</li>
                  <li>❌ Yapay zeka modeli eğitimi (KESİNLİKLE KULLANILMAZ)</li>
                  <li>❌ Diğer kullanıcılarla paylaşım</li>
                  <li>❌ Ticari kullanım</li>
                </ul>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <ul className="text-sm text-gray-600 space-y-2">
                    ...
                    <li>• Erişim kayıtlarının tutulması</li>
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">Veri işlenmesine itiraz edebilirsiniz</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 mb-2">Yapay zeka destekli tez analizi için kullanılır. Google'ın veri politikası:</p>
                  <ul className="text-sm text-gray-600 list-disc pl-4 space-y-1">
                    <li>API aracılığıyla gönderilen veriler model eğitimi için kullanılmaz</li>
                    <li>KVKK ve veri koruma standartlarına uyumludur</li>
            ...
            <section>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                <p className="text-gray-700 mb-4">
                  Veri gizliliği hakkındaki sorularınız, talepleriniz veya şikayetleriniz için:
                </p>
