        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm max-w-sm">
              Tezinizi güvenle formatlamanıza, kaynak göstermenize ve cilalamanıza yardımcı pratik araçlar.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/#pricing" className="hover:text-blue-400 transition">Fiyatlandırma</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <span className="text-gray-500">KVKK Uyumlu</span>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="mt-8">
                ...
                <Image
                  ...
                  alt="Kabul edilen ödeme yöntemleri: iyzico, Mastercard, Visa, American Express, Troy"
                  width={320}
                  height={40}
