  ...
  return (
    <div className="relative max-w-6xl mx-auto">
          ...
          {[...testimonials, ...testimonials, ...testimonials].map((testimonial, index) => (
            ...
            >
              <div className="bg-white rounded-xl shadow-lg p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                ...
                <p className="text-gray-600 mb-4 min-h-[80px] leading-relaxed">
                  "{testimonial.text}"
                </p>
      ...
      <button
        ...
        className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-white rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 hover:bg-blue-50 disabled:opacity-50 disabled:cursor-not-allowed z-10 group"
      ...
      <button
        onClick={nextSlide}
        disabled={isTransitioning}
        className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-white rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 hover:bg-blue-50 disabled:opacity-50 disabled:cursor-not-allowed z-10 group"
